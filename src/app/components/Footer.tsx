...
const institutionalLinks = [
  ...
  { label: 'Seguranca', to: '/seguranca' },
  { label: 'Frete e Entrega', to: '/frete-e-entrega' },
  { label: 'Pagamento', to: '/pagamento' },
  { label: 'Depoimento de Clientes', to: '/depoimentos-de-clientes' },
];

const helpLinks = [
  { label: 'Politica de Troca e Devolucao', to: '/politica-de-troca-e-devolucao' },
  { label: 'Politica de Reembolso', to: '/politica-de-reembolso' },
  { label: 'Politica de Garantia', to: '/politica-de-garantia' },
...
const securitySeals: SecuritySeal[] = [
  {
    name: 'Compra Segura',
...
export function Footer() {
  ...
  useEffect(() => {
    try {
      ...
      if (!storedValue) setShowCookieConsent(true);
    } catch {
